...
filename = ['/uv/user/pgierz/tracers_1p2/expt/raw_inputs/RCP4m_velocity_000001.nc']
...
unix('cdo -t mpiom1 -f nc setgrid,/csys/nobackup1_PALEO/pgierz/dump/GR30s.nc -setgrid,r122x101 /uv/user/pgierz/tracers_1p2/expt/raw_inputs/RCP4m_velocity_000001.nc /uv/user/pgierz/tracers_1p2/expt/raw_inputs/RCP4m_velocity_000001_normalgrid.nc');
unix('cdo remapcon,r360x180 /uv/user/pgierz/tracers_1p2/expt/raw_inputs/RCP4m_velocity_000001_normalgrid.nc /uv/user/pgierz/tracers_1p2/expt/raw_inputs/RCP4m_velocity_000001_normalgrid_r360x180.nc');
unix('mv /uv/user/pgierz/tracers_1p2/expt/raw_inputs/RCP4m_velocity_000001_normalgrid_r360x180.nc /uv/user/pgierz/tracers_1p2/expt/raw_inputs/RCP4m_velocity_000001_normalgrid_r360x180_final.nc');

filename = ['/uv/user/pgierz/tracers_1p2/expt/raw_inputs/RCP4m_velocity_000001_normalgrid_r360x180_final.nc'];
ncid_file   = netcdf.open([filename],'NC_WRITE');
varid_u = netcdf.inqVarID(ncid_file,'UKO');
